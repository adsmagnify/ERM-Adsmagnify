...
-- Clock in after 10:45 AM IST = Half day (Late arrival), stays Half day.
-- On time but clock out before 7:00 PM IST on the work date = Half day (Left early).
...
begin
  ...
  late := in_local::time > time '10:45:00';
  left_early := out_local < (work_date::timestamp + time '19:00:00');
...
begin
  ...
  if tg_op = 'UPDATE' then
    ...
    if new.clock_out is not null then
      ...
      from private.evaluate_attendance(new.clock_in, new.clock_out) e;
